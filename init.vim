...
" General {
    ...
    colorscheme retrowave "deus gruvbox
...
" Plugins {
    ...
    " Ctags {
        set tags=./tags;/,$XDG_CONFIG_HOME/vim/.vimtags
    ...
    " PyMode {
        ...
        if isdirectory(expand("$XDG_CONFIG_HOME/vim/bundle/python-mode"))
    ...
    " TagBar {
        if isdirectory(expand("$XDG_CONFIG_HOME/vim/bundle/tagbar/"))
    ...
    " Snippets {
        if count(g:spf13_bundle_groups, 'neocomplcache') ||
            ...
            let g:neosnippet#snippets_directory='$XDG_CONFIG_HOME/vim/bundle/vim-snippets/snippets'
    ...
    " UndoTree {
        if isdirectory(expand("$XDG_CONFIG_HOME/vim/bundle/undotree/"))
    ...
    " indent_guides {
        if isdirectory(expand("$XDG_CONFIG_HOME/vim/bundle/vim-indent-guides/"))
